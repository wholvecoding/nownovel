package com.wolvescoding.nownovel.manager.mq;

import com.wolvescoding.nownovel.core.constant.AmqpConstans;
...
public class AmqpMsgManager {
    ...
    public void sendBookChangeMsg(Long bookId) {
        if (amqpEnabled) {
            sendAmqpMessage(amqpTemplate, AmqpConstans.BookChangeMq.EXCHANGE_NAME, null, bookId);
        }
    }
